...
# HTML + CSS inline para no depender de archivos externos
HTML_PAGE = """
<!DOCTYPE html>
<html lang="es">
<head>
...
input[type=text], input[type=file] { padding:10px; margin:10px; width:300px; }
...
<input type="text" id="repo_url" placeholder="https://github.com/usuario/proyecto">
<button onclick="generateGitHub()">Generar APK</button>

<p>O sube archivos de tu proyecto:</p>
<input type="file" id="project_file">
<button onclick="generateFile()">Generar APK</button>
...
def generate_upload():
    ...
    # Aquí podrías descomprimir APKs o proyectos zip si quieres
    return {'success': False, 'error':'Función de archivos aún en desarrollo'}, 501
